                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror"
                                        name="code" value="{{ $kerusakan->code }}" placeholder="kode kerusakan">
                                    @error('code')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ $kerusakan->name }}"
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="education_id" id="exampleFormControlSelect1">
                                        ...
                                        @foreach ($educations as $edu)
                                            <option value="{{ $edu->id }}"
                                                {{ $edu->id === $kerusakan->education_id ? 'selected' : '' }}>
                                                {{ $edu->category }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="description"
                                        name="description" placeholder="keterangan">{{ $kerusakan->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
